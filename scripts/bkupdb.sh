...
mysqldump --user=barton --no-data --password=7098653 bartonphillips > $dir/bartonphillips.schema
mysqldump --user=barton --add-drop-table --password=7098653 bartonphillips >$dir/$filename
