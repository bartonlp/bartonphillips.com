...
```
    ...
    // "defaultCss": true, // If this is set to true or false then NO default
    // header at all.
    ...
    "dbinfo": { // only $this
      ...
      // "password": "", // Usually not used as the valuse is retrieved
      // from a file on disk.
     ...
     * ErrorClass::set{item name leading capital}() or
     * ErrorClass::get{item name leading capital}()
     */ 
    "errorMode": { // only $this. 
      "development": false, //true, // development automatically sets email to true.
    ...
    // The following can also be set via $S 
    //
