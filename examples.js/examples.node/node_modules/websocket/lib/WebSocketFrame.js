...
WebSocketFrame.prototype.toBuffer = function(nullMask) {
    ...
    if (this.mask) {
      // BLP 2022-02-11 -- It seems that random may generate an error
      // with very large values ie very near to 1. Remove on of the F's
        let ran = (Math.random()* 0xFFFFFFF/*F*/);
        //console.log("ran: " + ran);
      
        maskKey = nullMask ? 0 : ran | 0;
