...
<div id="header">
   <h1>Granby Ranch Fairway Cabins Home Owners</h1>
</div>
<hr/>
<?php
echo <<<EOF
...
$result = $B->query("select * from fairway order by name");
...
print("<form action='/fairway/multmail.php' method='post'>\n");
...
while($row = mysql_fetch_array($result)) {
  ...
  print("<input type=checkbox name=Name[] value='$id'><a href='/fairway/email.php?id=$id'>$name</a><br/>\n");
}
echo <<<EOF
