...
if(!preg_match("(^http://www.bartonphillips\.com|http://www\.google.com/reader/view/\?source=gmailnonewmail)i", $referer) && ($_REQUEST['mail'] != 1)) {
...
$result = $B->query("select email, name from fairway where id='$id'");
